...
<div class="flex aic jcsa col-12 espaceTB">
        ...
        <table class="col-12">
           ...
           <?php foreach ($pay["commandes"] as $key => $value): ?>
                <tr>
                    ...
                    <td><?=$value["verser"] ?></td>
                    <td><?=$value["restant"] ?></td>
                    <td><button class="bgreen"> <a href="<?= path('payement', 'addToVersement', ['line' =>$key ]) ?>" class="whitecol">ADD</a></button> </td>
                </tr>
                <?php endforeach ?>
    ...
    <div class="adpay col-6">
        <form action="<?= WEBROOT ?>" method="get" style="display: block;">
        <div class="flex">
        ...
        <div class="flex aiend">
            <button class="bgreen mb1" type="submit" value="page" name="addVersement" >Valider</button>
        </div>
        <table class="col-12 tabpay">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><input type="number" value=" " name="<?='verse'.$key?>" class="col-12"></td>
                    <td>
                    ...
                    <td><input type="text" value=" " name="<?='refmode'.$key?>" class="col-12"> </td>
                    <td> <button class="bred"><a href="<?= path('payement', 'removeToVersement', ['remove' => $key]) ?>" class="whitecol">Enlever</a></button>  </td>
                </tr>
                <?php endforeach ?>
            </tbody>
